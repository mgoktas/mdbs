...
const One = () => {
    ...
    return  (
        <SafeAreaView style={{backgroundColor: 'black', flex: 1,}}>
            ...
            <TextSmall value={'or'} />
            <CustomLgButton text={'Sign in with Google'} bck={'white'} icon={'google'} />
            <Space space={10}/>
            <CustomLgButton text={'Sign in with Apple'} bck={'white'}  icon={'apple'}/>
            <Space space={10}/>
            <CustomLgButton text={'Sign in with Facebook'} bck={'white'} icon={'facebook'} />
            <Space space={10}/>
